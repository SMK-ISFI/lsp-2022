...
<body class="layout-3">
  <div id="app">
    <div class="main-wrapper container">
      ...
      if (isset($_POST['pilih'])) {
        $_SESSION['post'] = [$_POST['paket'], $_POST['harga'], $_POST['id']];
      }
      ?>
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group mt-3">
                    ...
                    <button type="submit" class="btn btn-md btn-primary" name="simpan-transaksi">Simpan Transaksi</button>
                  </div>
                </div>
              </div>
            </div>
  ...
  if (isset($_POST['simpan-transaksi'])) {
    ...
    } elseif ($_POST['tambahan'] === "10000") {
      $tambahan = "Wax";
    } elseif ($_POST['tambahan'] === "20000") {
      $tambahan = "Fogging";
    }

    $notransaksi  = $_POST['no-transaksi'];
    $tgltransaksi = $_POST['tanggal'];
    $totalharga   = $_POST['total-harga'];
    $pembayaran   = $_POST['pembayaran'];
    $kembalian    = $_POST['kembalian'];
    $idpaketcuci  = $_SESSION['post'][2];
    $iduser       = $_SESSION['id'];

    $result = mysqli_query($con, "INSERT INTO tbtransaksi(idtransaksi, tgltransaksi, iduser, idpaketcuci, namapakettambahan, totalharga, pembayaran, kembalian) VALUES ('$notransaksi','$tgltransaksi','$iduser','$idpaketcuci','$tambahan','$totalharga','$pembayaran','$kembalian')");

    if ($result) {
      echo "<script>alert('Transaksi berhasil'); window.location='home.php'</script>";
    }
  }
  ?>
