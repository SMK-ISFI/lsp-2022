            ...
            <div class="table-responsive">
              <table class="table table-striped table-hover mt-2">
                ...
                <tbody>
                  ...
                  $results = mysqli_query($con, "SELECT * FROM tbtransaksi INNER JOIN tbpaketcuci ON tbtransaksi.idpaketcuci = tbpaketcuci.idpaket");
                  ...
                  while ($data = mysqli_fetch_array($results)) {
                    echo "
                      <tr>
                        ...
                        <td>
                          <a href='hapus-transaksi.php?no=$data[idtransaksi]' class='btn btn-sm btn-danger'>Hapus</a>
                        </td>
                      </tr>
                      ";
                  }
