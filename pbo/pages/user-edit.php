...
<body>
  <div id="app">
    <div class="main-wrapper">
      ...
      $user = new User();
      $result = $user->tampil_user($_GET['id']);
  ...
  if (isset($_POST['simpan'])) {
    $result = $user->edit_user($_GET['id'], $_POST['username']);

    if ($result) {
      echo "<script>alert('Data berhasil disimpan'); window.location='user.php'</script>";
    } else {
      echo "<script>alert('Data gagal disimpan'); window.location='user-edit.php?id=$_GET[id]'</script>";
    }
  }
  ?>
